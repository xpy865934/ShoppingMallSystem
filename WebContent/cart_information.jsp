							...
							<table class="address" width="100%">
								...
								<tr>
									...
									<td valign="top">
										...
										<table>
											<tr>
												<td><input type="radio" name="bank" id="bank01" value="" class="bankicon" /><label for="bank01"><img src="images/bank/bank01.gif" width="96" height="32" alt="" /></label></td>
												<td><input type="radio" name="bank" id="bank02" value="" class="bankicon" /><label for="bank02"><img src="images/bank/bank02.gif" width="96" height="32" alt="" /></label></td>
												<td><input type="radio" name="bank" id="bank03" value="" class="bankicon" /><label for="bank03"><img src="images/bank/bank03.gif" width="96" height="32" alt="" /></label></td>
												<td><input type="radio" name="bank" id="bank04" value="" class="bankicon" /><label for="bank04"><img src="images/bank/bank04.gif" width="96" height="32" alt="" /></label></td>
												<td><input type="radio" name="bank" id="bank05" value="" class="bankicon" /><label for="bank05"><img src="images/bank/bank05.gif" width="96" height="32" alt="" /></label></td>
											</tr>
											<tr>
												<td><input type="radio" name="bank" id="bank06" value="" class="bankicon" /><label for="bank06"><img src="images/bank/bank06.gif" width="96" height="32" alt="" /></label></td>
												<td><input type="radio" name="bank" id="bank07" value="" class="bankicon" /><label for="bank07"><img src="images/bank/bank07.gif" width="96" height="32" alt="" /></label></td>
												<td><input type="radio" name="bank" id="bank08" value="" class="bankicon" /><label for="bank08"><img src="images/bank/bank08.gif" width="96" height="32" alt="" /></label></td>
												<td><input type="radio" name="bank" id="bank09" value="" class="bankicon" /><label for="bank09"><img src="images/bank/bank09.gif" width="96" height="32" alt="" /></label></td>
												<td><input type="radio" name="bank" id="bank10" value="" class="bankicon" /><label for="bank10"><img src="images/bank/bank10.gif" width="96" height="32" alt="" /></label></td>
											</tr>
											<tr>
												<td><input type="radio" name="bank" id="bank11" value="" class="bankicon" /><label for="bank11"><img src="images/bank/bank11.gif" width="96" height="32" alt="" /></label></td>
												<td><input type="radio" name="bank" id="bank12" value="" class="bankicon" /><label for="bank12"><img src="images/bank/bank12.gif" width="96" height="32" alt="" /></label></td>
												<td><input type="radio" name="bank" id="bank13" value="" class="bankicon" /><label for="bank13"><img src="images/bank/bank13.gif" width="96" height="32" alt="" /></label></td>
												<td><input type="radio" name="bank" id="bank14" value="" class="bankicon" /><label for="bank14"><img src="images/bank/bank14.gif" width="96" height="32" alt="" /></label></td>
											</tr>
											<tr>
												<td><input type="radio" name="bank" id="bank15" value="" class="bankicon" /><label for="bank15"><img src="images/bank/bank15.gif" width="96" height="32" alt="" /></label></td>
												<td><input type="radio" name="bank" id="bank16" value="" class="bankicon" /><label for="bank16"><img src="images/bank/bank16.gif" width="96" height="32" alt="" /></label></td>
												<td><input type="radio" name="bank" id="bank17" value="" class="bankicon" /><label for="bank17"><img src="images/bank/bank17.gif" width="96" height="32" alt="" /></label></td>
												<td><input type="radio" name="bank" id="bank18" value="" class="bankicon" /><label for="bank18"><img src="images/bank/bank18.gif" width="96" height="32" alt="" /></label></td>
												<td><input type="radio" name="bank" id="bank19" value="" class="bankicon" /><label for="bank19"><img src="images/bank/bank19.gif" width="96" height="32" alt="" /></label></td>
											</tr>
											<tr>
												<td><input type="radio" name="bank" id="bank20" value="" class="bankicon" /><label for="bank20"><img src="images/bank/bank20.gif" width="96" height="32" alt="" /></label></td>
											</tr>
										</table>
									</td>
								</tr>
						...
						<td class="summary">
							<div class="f-l" style="width:640px;">
								<table class="ddbox" width="100%">
									...
									<tr>
										<td valign="top" align="right">使用优惠券：</td><td><input type="text" name="" value="" id="" class="stext f-l" style="width:227px;" /><a style="margin-left:10px;display:inline;" class="f-l" href="#"><img src="images/shiyong.gif" width="62" height="24" alt="使用" /></a><div class="clear"></div><p>优惠券一旦使用，在订单生成后，将无法退回。如您取消订单，订单中所使用的优惠券将永久失效，无法找回。<a class="blue" href="#">详见帮助中心优惠券使用细则第4条</a></p></td>
									</tr>
									<tr>
										<td align="right"><input type="checkbox" name="" id="thispl" value="" /> <label for="thispl"><img src="images/lpicon.gif" /></label></td><td></td>
									</tr>
									<tr>
